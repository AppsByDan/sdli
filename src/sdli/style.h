...
#define CLS_BUTTON_ICON "btn-icon"
#define CLS_BUTTON_ICON_HOVER "btn-icon-hover"
#define CLS_BUTTON_STRETCH "btn-stretch"
#define CLS_BUTTON_STRETCH_HOVER "btn-stretch-hover"
#define CLS_MENU "menu"
#define CLS_MENU_BUTTON "menu-btn"
#define CLS_MENU_BUTTON_HOVER "menu-btn-hover"
